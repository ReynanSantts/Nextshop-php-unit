...
<header class="custom-header">
    ...
    <form role="search" aria-label="Buscar lojas e produtos" class="search-form">
        <div class="search-bar">
            ...
            <input type="search" class="search-input" placeholder="Buscar lojas e produtos..." aria-label="Buscar lojas e produtos"/>
        </div>
    </form>
        ...
        <section class="products-carousel d-flex gap-3 overflow-auto pb-3">
            ...
            <article class="product-card">
                <div class="position-relative d-flex justify-content-center align-items-center" style="height: 160px;">
                    <img src="../images/fonekqz.png" alt="Fone De Ouvido In-ear Kz Edx Pro retorno de palco" class="img-fluid" style="max-height: 140px; object-fit: contain;" />
            ...
            <article class="product-card">
                ...
                <div class="p-2 small lh-sm text-uppercase">
                    Processador AMD Ryzen 5 5500, 6-Core, 12-Threads, 3.6GHz (4.2GHz Turbo), Cache 19MB, AM4    
                </div>
                <div class="px-2 pb-2">
